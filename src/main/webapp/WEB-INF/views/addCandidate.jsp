...
<body>
	...
	<div class="wrapper">
		...
		<form:form method="POST" action="passAdd" modelAttribute="candidatedata">
			<div class="container-fluid">
				<div class="row py-2">
					<div class="card card-stats col-5 offset-1">
						<div class="card-header bg-white border-bottom-0">
							...
							<div class="row">
								...
								<div class="col">
									<form:input id="dob" path="dob"  type="text" class="form-control" required="required" onfocusout="return validDate()" />
								</div>
							</div>
							<div class="row">
								<div class="col-3 mt-2">
								...
								<div class="col">
									<form:input id="email" path="e_mail" type="text" class="form-control" required="required"/>
								</div>
							</div>
							<div class="row">
								<div class="col-3 mt-2">
							...
							<div class="row">
								...
								<div class="col">
									<form:input path="facebook" type="text" class="form-control" required="required"/>
								</div>
							</div>
						</div>
					</div>
					<div class="card card-stats col-5 ml-1">
						<div class="card-header bg-white border-bottom-0">
								...
								<div class="col">
									<form:select path="faculty_code.faculty_code" class="form-control dropdownschool">
										<c:forEach items="${facultydata}" var="facultytInfo">
											<form:option value="${facultytInfo.faculty_code}" label="${facultytInfo.faculty_name}" />
										</c:forEach>
									</form:select>
								</div>
							</div>
							<div class="row border-bottom mb-2">
								...
								<div class="col">
									<form:input path="university_graduation_date" type="text" class="form-control" required="required"/>
								</div>
							</div>
							<div class="row mt-3">
								...
								<div class="col">
									<form:select path="campuslink_code.campuslink_code" class="form-control dropdownschool">
										<c:forEach items="${campuslinkdata}" var="camtInfo">
											<form:option value="${camtInfo.campuslink_code}" label="${camtInfo.campuslink_name}" />
										</c:forEach>
									</form:select>
								</div>
							</div>
								...
								<div class="col">
									<form:select path="sub_subject_type_code.sub_subject_code" class="form-control dropdownschool">
										<c:forEach items="${subdata}" var="subtInfo">
											<form:option value="${subtInfo.sub_subject_code}" label="${subtInfo.sub_subject_type_name}" />
										</c:forEach>
									</form:select>
								</div>
							</div>
