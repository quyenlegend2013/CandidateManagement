...
<head>
    ...
    <script type="text/javascript">
        ...
        function code() {
        	...
        	var noi="";
        	noi = uni +"_" +cam +"_"+ sub +"_"+ site + year+"_"+classs;
        	
        	document.getElementById("course_code").value = noi;
        }
...
<div class="wrapper">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li class="active"><a href="#pageSubmenu" data-toggle="collapse"> <i
    ...
    <div id="content">
      ...
      <form:form method="POST" action="passUpdateEvent" modelAttribute="EditEventData"> 
        <div class="container-fluid">
            <div class="row py-2">
                <div class="card card-stats col-5 offset-1">
                    <div class="card-header bg-white border-bottom-0">
                        ...
                        <form:hidden path="event_code"/>
                        <div class="row">
                            <div class="col-4 mt-2">
                                <p>Site:</p>
                            </div>
                            <div class="col">
                                <form:input id="site" path="site" type="text" class="form-control" readonly="true"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-4 mt-2">
                            ...
                            <div class="col">
                                <div class="container">
                                    <div class="row">
                                        <form:select id="university" path="university_code.university_code" class="form-control" readonly="true">
											<c:forEach items="${universitydata}" var="unitInfo">
												<form:option value="${unitInfo.university_code}" label="${unitInfo.university_code}" />
											</c:forEach>
										</form:select>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="container">
                                    <div class="row">
                                        <form:select id="campuslink" path="course_name.campuslink_code" class="form-control" readonly="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <form:select id="sub" path="sub_subject_type_code.sub_subject_code" class="form-control" readonly="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <form:input id="coure" path="course_code" type="text" class="form-control" readonly="true"/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                 <form:select path="course_status" class="form-control">
                ...
                <div class="card card-stats col-5 ml-1">
                    <div class="card-header bg-white border-bottom-0">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col">
                                <form:input path="planned_end_date" type="text" class="form-control" onfocusout="validDate()"/>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <form:input path="actual_end_date" type="text" class="form-control" onfocusout="validDate1()"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-4 mt-2">
                            ...
                            <div class="col">
                                <form:input path="actual_learning_time" type="text" class="form-control" readonly="true"/>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col text-center ml-4 mt-3">
                    <p>
                        ...
                        <button type="reset"  class="btn btn-secondary" onclick="return confirm('everything be edit won't save ?')" >Cancel</button>
                    </p>
                </div>
            </div>
        </div>
